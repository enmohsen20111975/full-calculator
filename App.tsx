...
const categories: Category[] = [
  { id: 'math', name: 'Mathematics', constants: constants.Math, equations: mathEquations },
  ...
  { id: 'electrical', name: 'Electrical Eng.', constants: constants.Electrical, equations: electricalEquations },
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-slate-200 font-sans p-4 sm:p-6 lg:p-8">
      ...
      <main>
        ...
        />
        <div className="mt-6">
          <CategoryView key={activeCategory.id} category={activeCategory} />
        </div>
      </main>
